...
const CONTACTO = {
  ...
  whatsappHref:
    "https://api.whatsapp.com/send/?phone=573118745980&text=Hola%2C%20me%20interesa%20conocer%20m%C3%A1s%20sobre%20Athletic%20Barf",
  ...
  facebook:
    "https://www.facebook.com/athleticbarf/?ref=NONE_xav_ig_profile_page_web",
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        ...
        <p className="text-sm font-bold text-gray-900 mt-0.5 group-hover:text-green-700 transition-colors truncate">
          {value}
        </p>
        {label && (
          <p className="text-xs text-green-600 font-semibold mt-1">{label}</p>
        )}
      </div>
    </a>
  );
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="mt-4 text-gray-500 text-lg max-w-xl mx-auto leading-relaxed">
            Escríbenos por WhatsApp, llámanos o síguenos en redes sociales. Con
            gusto te asesoramos sobre nuestros productos BARF.
          </p>
          <a
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
            ...
            <p className="text-xs text-gray-400 mb-5">
              Recetas, tips nutricionales y novedades de Athletic Barf.
            </p>
            <div className="space-y-3">
              ...
              >
                ...
                <span className="ml-auto text-xs font-bold text-pink-500 group-hover:translate-x-0.5 transition-transform">
                  →
                </span>
              </a>
              ...
              >
                ...
                <span className="ml-auto text-xs font-bold text-blue-500 group-hover:translate-x-0.5 transition-transform">
                  →
                </span>
              </a>
              ...
              >
                ...
                <span className="ml-auto text-xs font-bold text-green-500 group-hover:translate-x-0.5 transition-transform">
                  →
                </span>
              </a>
            </div>
          ...
          <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 rounded-xl bg-gray-50 border border-gray-100 px-4 py-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">
                      Cúcuta y Norte de Santander · Envíos nacionales
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3 rounded-xl bg-gray-50 border border-gray-100 px-4 py-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">
                      Estado Táchira · Único proveedor BARF en el país
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
              ...
              <p className="text-xs text-gray-400 mt-1">
                Pedidos por WhatsApp disponibles las 24 horas
              </p>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-green-600 mt-1">
                    Escríbenos y un asesor te ayudará a elegir el plan ideal.
                  </p>
                  <a
                    href={CONTACTO.whatsappHref}
                    target="_blank"
