...
export default function RegisterPage() {
  ...
  const handleRegister = async (e) => {
    ...
    if (!correo)
      validationErrors.correo = "El correo electrónico es requerido.";
      ...
      <Card className="border-zinc-200/60 shadow-xs bg-white text-center">
        ...
        <CardContent className="pb-6 pt-2 space-y-4">
          <p className="text-xs text-zinc-400 font-medium">
            Redirigiéndote al inicio de sesión en{" "}
    ...
    <Card className="border-zinc-200/60 shadow-xs bg-white">
      <CardHeader className="space-y-1.5 pb-6">
        ...
        <CardDescription className="text-zinc-500 text-sm">
          Únete a Athletic Barf para adquirir la mejor nutrición natural para tu
          mascota.
        </CardDescription>
      </CardHeader>
