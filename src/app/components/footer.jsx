    ...
    <footer className="bg-black border-t border-gray-200 border-t-2 border-green-600">
      <div className="max-w-6xl mx-auto pt-4 pb-4 grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center text-center">
        <div className="flex flex-col items-center">
          <h2 className="text-xl font-bold text-green-700">ATHLETIC BARF</h2>
          <p className="text-white mt-3 text-sm max-w-xs">
            Alimentación natural y balanceada para mascotas. Mejora su bienestar
            con productos frescos, seguros y nutritivos.
          </p>
        </div>
