...
export default function HistorialFilters({ filters, setFilters, onReset }) {
  ...
  const inputClass =
    "w-full rounded-xl border border-gray-200 bg-gray-50/50 px-3 py-2 text-sm text-black placeholder-gray-400 focus:border-orange-500 focus:bg-white focus:outline-none transition-all font-medium h-10";
  const labelClass =
