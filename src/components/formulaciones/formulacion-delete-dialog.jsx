              ...
              {esEliminacionMultiple ? (
                  ...
                  <div className="space-y-1 max-h-32 overflow-y-auto">
                    {items.map((ing, idx) => {
                      const ingredienteData =
                        ingredientesMap[ing.id_ingrediente];
                      return (
                        <div
                          key={ing.id}
                          className="flex items-center justify-between text-xs py-1 px-2 rounded bg-white"
                        >
                          ...
                          <span className="text-gray-500">
                            {parseFloat(ing.porcentaje_ingrediente).toFixed(1)}%
                          </span>
                        </div>
                      );
                    })}
                ...
                <>
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-medium text-gray-900">
                      {ingredientesMap[firstItem.id_ingrediente]?.nombre ||
                        `#${firstItem.id_ingrediente}`}
                    </span>
                  </div>
